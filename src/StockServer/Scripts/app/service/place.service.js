        ...
        execute: function() {
            PlaceService = (function () {
                function PlaceService(http) {
                    this.http = http;
                    this.maxReturnItems = 1000;
                    this.baseUrl = "api/v1/place/";
                }
                PlaceService.prototype.getByPoint = function (lat, lon, radius, limit) {
                ...
                PlaceService.prototype.info = function (id) {
